...
export default function Register() {
  ...
  const handleSubmit = async (e: any) => {
    ...
    console.log("กำลังดำเนินการสมัครสมาชิกสำหรับ:", { username, email, password });
      ...
      <div className="bg-white w-full max-w-5xl rounded-[2rem] shadow-2xl overflow-hidden flex flex-col lg:flex-row min-h-[650px]">
        ...
        <div className="w-full lg:w-1/2 p-8 sm:p-12 lg:p-16 flex flex-col justify-center bg-white">
          <div className="max-w-md mx-auto w-full">
            ...
            <h2 className="text-center text-3xl font-bold text-gray-900">สร้างบัญชีใหม่</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className={`w-full py-2 px-4 rounded-md text-white font-semibold transition-all ${isLoading ? 'bg-gray-400' : 'bg-[#2E7CF6] hover:bg-[#0747A6]'
                  }`}
              >
